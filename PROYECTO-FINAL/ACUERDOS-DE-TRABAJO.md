...
| 2026-09-02  | Parte 7 | Se agregan Vercel Serverless Functions (`api/`) equivalentes al backend de Express, y `vercel.json` para el despliegue. Falta completar el import del proyecto en la cuenta de Vercel del alumno (paso manual, fuera del repositorio). |
